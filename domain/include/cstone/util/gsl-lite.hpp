...
#define gsl_DETAIL_CFG_NO_VALUE_1                                                                                      \
    1 // many compilers treat the command-line parameter "-Dfoo" as equivalent to "-Dfoo=1", so we tolerate that
...
#pragma message("invalid configuration value gsl_CONFIG_ALLOWS_SPAN_CONTAINER_CTOR=" gsl_STRINGIFY(                    \
...
#pragma message("invalid configuration value gsl_CONFIG_CONTRACT_LEVEL_EXPECTS_ONLY=" gsl_STRINGIFY(                   \
...
#pragma message("invalid configuration value gsl_CONFIG_CONTRACT_LEVEL_ENSURES_ONLY=" gsl_STRINGIFY(                   \
...
#pragma message(                                                                                                       \
    "invalid configuration value gsl_FEATURE_OWNER_MACRO=" gsl_STRINGIFY(gsl_FEATURE_OWNER_MACRO) ", must be 0 or 1")
#endif
#else
...
#pragma message("invalid configuration value gsl_FEATURE_EXPERIMENTAL_RETURN_GUARD=" gsl_STRINGIFY(                    \
...
#pragma message("invalid configuration value gsl_CONFIG_CONFIRMS_COMPILATION_ERRORS=" gsl_STRINGIFY(                   \
...
#pragma message("invalid configuration value gsl_CONFIG_ALLOWS_NONSTRICT_SPAN_COMPARISON=" gsl_STRINGIFY(              \
...
#pragma message("invalid configuration value gsl_CONFIG_ALLOWS_UNCONSTRAINED_SPAN_CONTAINER_CTOR=" gsl_STRINGIFY(      \
...
#pragma message("invalid configuration value gsl_CONFIG_NARROW_THROWS_ON_TRUNCATION=" gsl_STRINGIFY(                   \
...
#pragma message("invalid configuration value gsl_CONFIG_CONTRACT_CHECKING_EXPECTS_OFF=" gsl_STRINGIFY(                 \
...
#pragma message("invalid configuration value gsl_CONFIG_CONTRACT_CHECKING_ENSURES_OFF=" gsl_STRINGIFY(                 \
...
#pragma message("invalid configuration value gsl_CONFIG_CONTRACT_CHECKING_ASSERT_OFF=" gsl_STRINGIFY(                  \
...
#pragma message("invalid configuration value gsl_CONFIG_CONTRACT_VIOLATION_TERMINATES=" gsl_STRINGIFY(                 \
...
#pragma message("invalid configuration value gsl_CONFIG_CONTRACT_VIOLATION_ASSERTS=" gsl_STRINGIFY(                    \
...
#pragma message("invalid configuration value gsl_CONFIG_CONTRACT_VIOLATION_CALLS_HANDLER=" gsl_STRINGIFY(              \
...
#pragma message("invalid configuration value gsl_CONFIG_UNENFORCED_CONTRACTS_ASSUME=" gsl_STRINGIFY(                   \
...
#pragma message("invalid configuration value gsl_CONFIG_UNENFORCED_CONTRACTS_ELIDE=" gsl_STRINGIFY(                    \
...
#error only one of gsl_CONFIG_CONTRACT_CHECKING_AUDIT, gsl_CONFIG_CONTRACT_CHECKING_ON, and gsl_CONFIG_CONTRACT_CHECKING_OFF may be defined
            ...
            defined(gsl_CONFIG_CONTRACT_VIOLATION_ASSERTS) + defined(gsl_CONFIG_CONTRACT_VIOLATION_TRAPS) +            \
...
// AppleClang  7.0.0  __apple_build_version__ ==  7000172  gsl_COMPILER_APPLECLANG_VERSION ==  700  (Xcode 7.0, 7.0.1)
// (LLVM  3.7.0) AppleClang  7.0.0  __apple_build_version__ ==  7000176  gsl_COMPILER_APPLECLANG_VERSION ==  700
// (Xcode 7.1)                      (LLVM  3.7.0) AppleClang  7.0.2  __apple_build_version__ ==  7000181
// gsl_COMPILER_APPLECLANG_VERSION ==  702  (Xcode 7.2, 7.2.1)               (LLVM  3.7.0) AppleClang  7.3.0
// __apple_build_version__ ==  7030029  gsl_COMPILER_APPLECLANG_VERSION ==  730  (Xcode 7.3) (LLVM  3.8.0)
// AppleClang  7.3.0  __apple_build_version__ ==  7030031  gsl_COMPILER_APPLECLANG_VERSION ==  730  (Xcode 7.3.1)
// (LLVM  3.8.0) AppleClang  8.0.0  __apple_build_version__ ==  8000038  gsl_COMPILER_APPLECLANG_VERSION ==  800
// (Xcode 8.0)                      (LLVM  3.9.0) AppleClang  8.0.0  __apple_build_version__ ==  8000042
// gsl_COMPILER_APPLECLANG_VERSION ==  800  (Xcode 8.1, 8.2, 8.2.1)          (LLVM  3.9.0) AppleClang  8.1.0
// __apple_build_version__ ==  8020038  gsl_COMPILER_APPLECLANG_VERSION ==  810  (Xcode 8.3) (LLVM  3.9.0)
// AppleClang  8.1.0  __apple_build_version__ ==  8020041  gsl_COMPILER_APPLECLANG_VERSION ==  810  (Xcode 8.3.1)
// (LLVM  3.9.0) AppleClang  8.1.0  __apple_build_version__ ==  8020042  gsl_COMPILER_APPLECLANG_VERSION ==  810
// (Xcode 8.3.2, 8.3.3)             (LLVM  3.9.0) AppleClang  9.0.0  __apple_build_version__ ==  9000037
// gsl_COMPILER_APPLECLANG_VERSION ==  900  (Xcode 9.0)                      (LLVM  4.0.0) AppleClang  9.0.0
// __apple_build_version__ ==  9000038  gsl_COMPILER_APPLECLANG_VERSION ==  900  (Xcode 9.1) (LLVM  4.0.0)
// AppleClang  9.0.0  __apple_build_version__ ==  9000039  gsl_COMPILER_APPLECLANG_VERSION ==  900  (Xcode 9.2)
// (LLVM  4.0.0) AppleClang  9.1.0  __apple_build_version__ ==  9020039  gsl_COMPILER_APPLECLANG_VERSION ==  910
// (Xcode 9.3, 9.3.1)               (LLVM  5.0.2) AppleClang  9.1.0  __apple_build_version__ ==  9020039
// gsl_COMPILER_APPLECLANG_VERSION ==  910  (Xcode 9.4, 9.4.1)               (LLVM  5.0.2) AppleClang 10.0.0
// __apple_build_version__ == 10001145  gsl_COMPILER_APPLECLANG_VERSION == 1000  (Xcode 10.0, 10.1) (LLVM  6.0.1)
...
// gsl_COMPILER_APPLECLANG_VERSION == 1100  (Xcode 11.1, 11.2, 11.3, 11.3.1) (LLVM  8.0.0) AppleClang 11.0.3
// __apple_build_version__ == 11030032  gsl_COMPILER_APPLECLANG_VERSION == 1103  (Xcode 11.4, 11.4.1, 11.5, 11.6)
// (LLVM  9.0.0) AppleClang 12.0.0  __apple_build_version__ == 12000032  gsl_COMPILER_APPLECLANG_VERSION == 1200
// (Xcode 12.0–12.4)                (LLVM 10.0.0) AppleClang 12.0.5  __apple_build_version__ == 12050022
// gsl_COMPILER_APPLECLANG_VERSION == 1205  (Xcode 12.5)                     (LLVM 10.0.0)
...
// In pre-3.5, __has_feature(cxx_exceptions) can be true if ObjC exceptions are enabled, but C++ exceptions are
// disabled. The recommended way to check is `__EXCEPTIONS && __has_feature(cxx_exceptions)`. See
// https://releases.llvm.org/3.6.0/tools/clang/docs/ReleaseNotes.html#the-exceptions-macro Note: this is only relevant
// in Objective-C++, thus the ifdef.
...
#define gsl_HAVE_NULLPTR_()                                                                                            \
    gsl_HAVE_NULLPTR // It's a language feature but needs library support, so we list it as a library feature.
...
#define gsl_HAVE_INITIALIZER_LIST_()                                                                                   \
    gsl_HAVE_INITIALIZER_LIST // It's a language feature but needs library support, so we list it as a library feature.
...
// NOTE: When using SFINAE in gsl-lite, please note that overloads of function templates must always use SFINAE with
// non-type default arguments
//       as explained in https://en.cppreference.com/w/cpp/types/enable_if#Notes. `gsl_ENABLE_IF_()` implements graceful
//       fallback to default type arguments (for compilers that don't support non-type default arguments); please verify
//       that this is appropriate in the given situation, and add additional checks if necessary.
//
//       Also, please note that `gsl_ENABLE_IF_()` doesn't enforce the constraint at all if no compiler/library support
//       is available (i.e. pre-C++11).
...
//
// NVCC imposes the restriction that a function annotated `__host__ __device__` cannot call host-only or device-only
// functions. This makes `gsl_api` inappropriate for generic functions that call unknown code, e.g. the template
// constructors of `span<>` or functions like `finally()` which accept an arbitrary  function object. It is often
// preferable to annotate functions only with `gsl_constexpr` or `gsl_constexpr14`. The "extended constexpr" mode of
// NVCC (currently an experimental feature) will implicitly consider constexpr functions `__host__ __device__` functions
    ...
    namespace gsl
{
    ...
    template<class E>
    gsl_NODISCARD inline gsl_constexpr auto data(std::initializer_list<E> il) gsl_noexcept->E const*
    {
        return il.begin();
    }
...
// Do not define any endianness constants for unknown compilers.
...
#else // ^^^ gsl_CPP11_140 && ! gsl_BETWEEN( gsl_COMPILER_GNUC_VERSION, 1, 500 ) ^^^ / vvv ! gsl_CPP11_140 ||
      // gsl_BETWEEN( gsl_COMPILER_GNUC_VERSION, 1, 500 ) vvv

    template<class C,
             class E,
             typename =
                 typename std::enable_if<!is_span<C>::value && !is_array<C>::value && !is_std_array<C>::value &&
    ...
    // VS2013 has insufficient support for expression SFINAE; we cannot make `is_compatible_container<>` a proper type
    // trait here
...
#define gsl_TRAP_()                                                                                                    \
    __fastfail(0) /* legacy failure code for buffer-overrun errors, cf. winnt.h, "Fast fail failure codes" */
#elif gsl_COMPILER_GNUC_VERSION
...
#define gsl_FAILFAST_()                                                                                                \
    (::gsl::fail_fast_assert_handler("", "GSL: failure", __FILE__, __LINE__),                                          \
     ::gsl::detail::fail_fast_terminate()) /* do not let the custom assertion handler continue execution */
#endif
...
#define gsl_CONTRACT_CHECK_(str, x)                                                                                    \
    ((x) ? static_cast<void>(0)                                                                                        \
         : ::gsl::detail::fail_fast_throw(str ": '" #x "' at " __FILE__ ":" gsl_STRINGIFY(__LINE__)))
...
#define gsl_FailFast() gsl_FAILFAST_()
    ...
    gsl_DEPRECATED_MSG("don't call gsl::fail_fast_assert() directly; use contract checking macros instead")
        ...
        fail_fast_assert(bool cond, char const* const expression, char const* const message, char const* const file,
                         int line)
    {
    ...
    inline unsigned char uncaught_exceptions() gsl_noexcept
    {
        return static_cast<unsigned char>(
            *reinterpret_cast<unsigned const*>(detail::_getptd() + (sizeof(void*) == 8 ? 0x100 : 0x90)));
    }
    ...
    inline unsigned char uncaught_exceptions() gsl_noexcept
    {
        return static_cast<unsigned char>((*reinterpret_cast<unsigned const*>(
            reinterpret_cast<unsigned char const*>(detail::__cxa_get_globals()) + sizeof(void*))));
    }
    ...
    public:
        ...
        final_action(final_action&& other) gsl_noexcept : action_(std::move(other.action_)), invoke_(other.invoke_)
        {
            other.invoke_ = false;
        }
    ...
    {
    public:
        explicit final_action_return(F&& action) gsl_noexcept : final_action<F>(std::move(action)),
                                                                exception_count(std11::uncaught_exceptions())
        {
        }

        final_action_return(final_action_return&& other) gsl_noexcept : final_action<F>(std::move(other)),
                                                                        exception_count(std11::uncaught_exceptions())
        {
        }
    ...
    {
    public:
        explicit final_action_error(F&& action) gsl_noexcept : final_action<F>(std::move(action)),
                                                               exception_count(std11::uncaught_exceptions())
        {
        }

        final_action_error(final_action_error&& other) gsl_noexcept : final_action<F>(std::move(other)),
                                                                      exception_count(std11::uncaught_exceptions())
        {
        }
        ...
        narrow(U u)
    {
        ...
        gsl_STATIC_ASSERT_(detail::dependent_false<T>::value,
                           "According to the GSL specification, narrow<>() throws an exception of type narrowing_error "
                           "on truncation. Therefore "
                           "it cannot be used if exceptions are disabled. Consider using narrow_failfast<>() instead "
                           "which raises a precondition "
    ...
    gsl_NODISCARD gsl_api inline gsl_constexpr14 typename Container::value_type& at(Container & cont, size_t pos)
    {
    ...
    template<class Container>
    gsl_NODISCARD gsl_api inline gsl_constexpr14 typename Container::value_type const& at(Container const& cont,
                                                                                          size_t pos)
    {
        gsl_Expects(pos < cont.size());
        return cont[pos];
    ...
    template<class T>
    gsl_NODISCARD gsl_api inline const gsl_constexpr14 T at(std::initializer_list<T> cont, size_t pos)
    {
        gsl_Expects(pos < cont.size());
...
// helper class to figure out the pointed-to type of a pointer
    ...
    struct not_null_data<T, false>
    {
        ...
        gsl_api gsl_constexpr14 not_null_data(not_null_data&& other) gsl_noexcept : ptr_(std::move(other.ptr_)) {}
...
#if gsl_HAVE(TYPE_TRAITS)
        static_assert(std::is_assignable<typename std::remove_const<typename std::remove_reference<T>::type>::type&,
                                         std::nullptr_t>::value,
...
#if gsl_HAVE(MOVE_FORWARD)
        template<class U
        // In Clang 3.x, `is_constructible<not_null<unique_ptr<X>>, unique_ptr<X>>` tries to instantiate the copy
        // constructor of `unique_ptr<>`, triggering an error. Note that Apple Clang's `__clang_major__` etc. are
        // different from regular Clang.
#if gsl_HAVE(TYPE_TRAITS) && gsl_HAVE(DEFAULT_FUNCTION_TEMPLATE_ARG) &&                                                \
...
#else  // a.k.a. !( gsl_HAVE( TYPE_TRAITS ) && gsl_HAVE( DEFAULT_FUNCTION_TEMPLATE_ARG ) && ! gsl_BETWEEN(
       // gsl_COMPILER_CLANG_VERSION, 1, 400 ) && ! gsl_BETWEEN( gsl_COMPILER_APPLECLANG_VERSION, 1, 1001 )
       // If type_traits are not available, then we can't distinguish `is_convertible<>` and `is_constructible<>`, so
       // we unconditionally permit implicit construction.
        template<class U>
        gsl_api gsl_constexpr14 not_null(U other)
            : data_(T(std::move(other)))
        {
    ...
    !gsl_BETWEEN(gsl_COMPILER_CLANG_VERSION, 1, 400) && !gsl_BETWEEN(gsl_COMPILER_APPLECLANG_VERSION, 1, 1001)
       ...
       // gsl_COMPILER_CLANG_VERSION, 1, 400 ) && ! gsl_BETWEEN( gsl_COMPILER_APPLECLANG_VERSION, 1, 1001 )
        ...
        template<
            ...
            // We *have* to use SFINAE with an NTTP arg here, otherwise the overload is ambiguous.
            ,
            typename std::enable_if<(std::is_convertible<T, U>::value && !detail::is_not_null_or_bool_oracle<U>::value),
                                    int>::type = 0>
...
#endif
#else  // a.k.a. #if !( gsl_HAVE( MOVE_FORWARD ) && gsl_HAVE( TYPE_TRAITS ) && gsl_HAVE( DEFAULT_FUNCTION_TEMPLATE_ARG )
       // && gsl_HAVE( EXPLICIT ) )
        template<class U>
        gsl_NODISCARD gsl_api gsl_constexpr14 operator U() const
        {
...
#endif // gsl_HAVE( MOVE_FORWARD ) && gsl_HAVE( TYPE_TRAITS ) && gsl_HAVE( DEFAULT_FUNCTION_TEMPLATE_ARG ) && gsl_HAVE(
       // EXPLICIT )
    ...
    !gsl_BETWEEN(gsl_COMPILER_CLANG_VERSION, 1, 400) && !gsl_BETWEEN(gsl_COMPILER_APPLECLANG_VERSION, 1, 1001)
       ...
       // EXPLICIT )
        ...
        gsl_NODISCARD gsl_api gsl_constexpr14 element_type& operator*() const { return *data_.ptr_; }
    ...
    gsl_NODISCARD inline gsl_api gsl_constexpr gsl_TRAILING_RETURN_TYPE_(bool) operator==(
        not_null<T> const& l, not_null<U> const& r) gsl_RETURN_DECLTYPE_(l.operator->() == r.operator->())
    {
...
//
    ...
    template<class IntegerType gsl_ENABLE_IF_((std::is_integral<IntegerType>::value))>
    gsl_NODISCARD gsl_api inline gsl_constexpr byte operator<<(byte b, IntegerType shift) gsl_noexcept
    {
        return ::gsl::to_byte(::gsl::to_uchar(b) << shift);
    }

    template<class IntegerType gsl_ENABLE_IF_((std::is_integral<IntegerType>::value))>
    gsl_NODISCARD gsl_api inline gsl_constexpr14 byte& operator>>=(byte& b, IntegerType shift) gsl_noexcept
    {
#if gsl_HAVE(ENUM_CLASS_CONSTRUCTION_FROM_UNDERLYING_TYPE)
        return b = ::gsl::to_byte(::gsl::to_uchar(b) >> shift);
#else
    ...
    const gsl_constexpr with_container_t with_container; // TODO: this can lead to ODR violations because the symbol
                                                         // will be defined in multiple translation units
    ...
    {
        // Be sure to run the check before doing pointer arithmetics, which would be UB for `nullptr` and non-0
        // integers.
    ...
    public:
        ...
        template<class Container
                 ...
                 //))
                 >
        gsl_constexpr span(Container const& cont) gsl_noexcept : first_(std17::data(cont)),
                                                                 last_(std17::data(cont) + std17::size(cont))
        {
        }
    ...
    template< class U > operator=();
        ...
        gsl_NODISCARD gsl_api gsl_constexpr14 span subspan(index_type offset, index_type count) const
        {
            gsl_Expects(std::size_t(offset) <= std::size_t(this->size()) &&
        ...
        gsl_NODISCARD gsl_api gsl_constexpr iterator begin() const gsl_noexcept { return iterator(first_); }

        gsl_NODISCARD gsl_api gsl_constexpr iterator end() const gsl_noexcept { return iterator(last_); }
        ...
        gsl_NODISCARD gsl_constexpr17 reverse_iterator rbegin() const gsl_noexcept { return reverse_iterator(end()); }

        gsl_NODISCARD gsl_constexpr17 reverse_iterator rend() const gsl_noexcept { return reverse_iterator(begin()); }
        ...
        gsl_DEPRECATED_MSG("use free function gsl::as_writable_bytes() instead") gsl_api span<byte> as_writeable_bytes()
            const gsl_noexcept
        {
    ...
    template<class T, class U>
    gsl_SUPPRESS_MSGSL_WARNING(stl .1) gsl_NODISCARD inline gsl_constexpr bool operator==(span<T> const& l,
                                                                                          span<U> const& r)
    {
    ...
    template<class T>
    gsl_NODISCARD gsl_api inline gsl_constexpr span<T> make_span(T * ptr, typename span<T>::index_type count)
    {
    ...
    gsl_NODISCARD inline gsl_constexpr auto make_span(Container & cont)->span<typename std::remove_pointer<EP>::type>
    {
    ...
    template<class Container>
    gsl_NODISCARD inline gsl_constexpr span<typename Container::value_type> make_span(with_container_t,
    ...
    public:
        ...
        gsl_NODISCARD gsl_constexpr14 basic_string_span first(index_type count) const { return span_.first(count); }

        /*gsl_api*/ // currently disabled due to an apparent NVCC bug
        gsl_NODISCARD gsl_constexpr14 basic_string_span last(index_type count) const { return span_.last(count); }
        ...
        /*gsl_api*/ // currently disabled due to an apparent NVCC bug
        gsl_NODISCARD gsl_constexpr14 basic_string_span subspan(index_type offset, index_type count) const
        {
        ...
        gsl_NODISCARD gsl_api gsl_constexpr index_type length() const gsl_noexcept { return span_.size(); }

        gsl_NODISCARD gsl_api gsl_constexpr index_type size() const gsl_noexcept { return span_.size(); }

        gsl_NODISCARD gsl_api gsl_constexpr index_type length_bytes() const gsl_noexcept { return span_.size_bytes(); }

        gsl_NODISCARD gsl_api gsl_constexpr index_type size_bytes() const gsl_noexcept { return span_.size_bytes(); }

        gsl_NODISCARD gsl_api gsl_constexpr bool empty() const gsl_noexcept { return size() == 0; }

        gsl_NODISCARD gsl_api gsl_constexpr14 reference operator[](index_type idx) const { return span_[idx]; }
        ...
        gsl_NODISCARD gsl_api gsl_constexpr pointer data() const gsl_noexcept { return span_.data(); }

        gsl_NODISCARD gsl_api gsl_constexpr iterator begin() const gsl_noexcept { return span_.begin(); }

        gsl_NODISCARD gsl_api gsl_constexpr iterator end() const gsl_noexcept { return span_.end(); }

        gsl_NODISCARD gsl_constexpr17 reverse_iterator rbegin() const gsl_noexcept { return span_.rbegin(); }

        gsl_NODISCARD gsl_constexpr17 reverse_iterator rend() const gsl_noexcept { return span_.rend(); }

        // const version not in p0123r2:

        gsl_NODISCARD gsl_api gsl_constexpr const_iterator cbegin() const gsl_noexcept { return span_.cbegin(); }

        gsl_NODISCARD gsl_api gsl_constexpr const_iterator cend() const gsl_noexcept { return span_.cend(); }

        gsl_NODISCARD gsl_constexpr17 const_reverse_iterator crbegin() const gsl_noexcept { return span_.crbegin(); }

        gsl_NODISCARD gsl_constexpr17 const_reverse_iterator crend() const gsl_noexcept { return span_.crend(); }
    ...
    template<class T, class U>
    gsl_NODISCARD inline gsl_constexpr14 bool operator!=(basic_string_span<T> const& l, U const& r) gsl_noexcept
    {
        return !(l == r);
    }
    ...
    template<class T, class U gsl_ENABLE_IF_((!detail::is_basic_string_span<U>::value))>
    gsl_NODISCARD inline gsl_constexpr14 bool operator!=(U const& l, basic_string_span<T> const& r) gsl_noexcept
    {
        return !(l == r);
    }
...
inline std::basic_string< typename std::remove_const<T>::type > to_string( basic_string_span<T> spn )
{
    ...
    Stream& write_to_stream(Stream& os, Span const& spn)
    {
        ...
        if (left_pad) detail::write_padding(os, os.width() - length);

        // Write span characters
        os.rdbuf()->sputn(spn.begin(), length);

        if (pad && !left_pad) detail::write_padding(os, os.width() - length);
    ...
    gsl_constexpr14 static span<T> ensure_sentinel(T* seq, SizeType max = (std::numeric_limits<SizeType>::max)())
    {
        ...
        gsl_SUPPRESS_MSVC_WARNING(
            26429, "f.23: symbol 'cur' is never tested for nullness, it can be marked as not_null") pointer cur = seq;
    ...
    template<class T>
    gsl_NODISCARD inline gsl_constexpr14 span<T> ensure_z(T* const& sz,
    ...
    template<class Container>
    gsl_NODISCARD inline gsl_constexpr14 span<typename std::remove_pointer<typename Container::pointer>::type> ensure_z(
        Container & cont)
    {
    ...
    public:
        ...
        gsl_NODISCARD gsl_api gsl_constexpr czstring_type assume_z() const gsl_noexcept { return span_.data(); }
...
struct hash<::gsl::not_null<T>>
    : public ::gsl::detail::conditionally_enabled_hash<is_default_constructible<hash<T>>::value>
{
public:
...
{
public:
    gsl_NODISCARD gsl_constexpr std::size_t operator()(::gsl::not_null<T*> const& v) const gsl_noexcept
    {
        return hash<T*>()(::gsl::as_nullable(v));
    }
};
