...
inline void check_add_start(const int start, const int count, const int *ordering, const double *x, const double *y, const double *z, const double xi, const double yi, const double zi, const double r, const int ngmax, int *ng, int &nvi)
{
...
void Tree::setBox(const double minx, const double maxx, const double miny, const double maxy, const double minz, const double maxz)
{
	_minx = minx;
	_maxx = maxx;
	_miny = miny;
...
void Tree::buildSort(const int n, const double *x, const double *y, const double *z, int **ordering)
{
	clean();
...
void Tree::buildSortRec(const vector<int> &list, const double *x, const double *y, const double *z, int it)
{
	//#pragma omp task
	{
		if(TREE)
...
void Tree::findNeighbors(const double xi, const double yi, const double zi, const double ri, const int ngmax, int *ng, int &nvi,
	const bool PBCx, const bool PBCy, const bool PBCz)
{
	...
	{
		int mix = floor(normalize(xi-ri, _minx, _maxx)*C);
		int miy = floor(normalize(yi-ri, _miny, _maxy)*C);
		int miz = floor(normalize(zi-ri, _minz, _maxz)*C);
		int max = floor(normalize(xi+ri, _minx, _maxx)*C);
		int may = floor(normalize(yi+ri, _miny, _maxy)*C);
		int maz = floor(normalize(zi+ri, _minz, _maxz)*C);
...
void Tree::findNeighborsRec(const double xi, const double yi, const double zi, const double ri, const int ngmax, int *ng, int &nvi)
{
