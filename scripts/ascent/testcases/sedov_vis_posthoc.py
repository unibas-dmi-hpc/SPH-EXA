...
file_path = "/home/appcell/unibas-sphexa/sphexa-vis/output/develop/sedov_session.yaml"
...
def plot_radial_density(curr_key, radial_density):
    ...
    plt.ylabel('Density')
    plt.savefig("sedov_rd_step{:05d}.png".format(curr_key))
    plt.clf()
