...
x_vals, x_size = bin_values(results["pdf_density/" + cycle +
                                    "/attrs/bin_axes/value/radius"])
y_vals, y_size = bin_values(results["pdf_density/" + cycle +
                                    "/attrs/bin_axes/value/Density"])
x, y = np.meshgrid(x_vals, y_vals)

c = plt.pcolormesh(x, y, results["pdf_density/" + cycle +
                                 "/attrs/value/value"].reshape(x_size, y_size),
