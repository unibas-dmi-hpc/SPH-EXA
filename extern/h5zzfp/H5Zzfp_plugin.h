...
#define H5Pget_zfp_rate_cdata(N, CD) ((double)(((N >= 4) && (CD[0] == H5Z_ZFP_MODE_RATE)) ? *((double*)&CD[2]) : 0))
...
#define H5Pget_zfp_precision_cdata(N, CD) ((double)(((N >= 3) && (CD[0] == H5Z_ZFP_MODE_PRECISION)) ? CD[2] : 0))
