...
#pragma omp target enter data map(to : wharmonicDerivativeLookupTable [0:wharmonicLookupTableSize])
        ...
        //cuda::CHECK_CUDA_ERR(cuda::utils::cudaMalloc(wharmonicLookupTableSize * sizeof(T), wharmonicLookupTable, wharmonicDerivativeLookupTable));
        cudaFree(0);
        ...
        cuda::CHECK_CUDA_ERR(cudaGetLastError());
