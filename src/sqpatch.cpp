...
int main()
{
    ...
    MomentumEnergySqPatch<Real> tMomentumEnergy(d.x, d.y, d.z, d.h, d.vx, d.vy, d.vz, d.ro, d.p, d.c, d.m, d.iteration, d.neighbors, d.grad_P_x, d.grad_P_y, d.grad_P_z, d.du);
