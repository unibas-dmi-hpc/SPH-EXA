...
int main()
{
    ...
    for(int iteration = 0; iteration < 200; iteration++)
    {
        ...
        REPORT_TIME(equationOfState.compute(iteration, d.ro_0, d.p_0, d.ro, d.p, d.u, d.c), "EquationOfState");
        REPORT_TIME(momentumEnergy.compute(iteration, d.neighbors, d.x, d.y, d.z, d.h, d.vx, d.vy, d.vz, d.ro, d.p, d.c, d.m, d.grad_P_x, d.grad_P_y, d.grad_P_z, d.du), "MomentumEnergy");
