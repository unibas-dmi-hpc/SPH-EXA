...
struct SedovDataFileWriter : IFileWriter<Dataset>
{
    ...
    {
        fprintf(stderr, "Warning: dumping checkpoint is not implemented in SedovDataFileWriter, exiting...\n");
        exit(EXIT_FAILURE);
    }
};
...
template <typename Dataset>
struct SedovDataMPIFileWriter : IFileWriter<Dataset>
{
    #ifdef SPH_EXA_HAVE_H5PART
    ...
    {
        if (d.rank == 0) fprintf(stderr, "Warning: dumping checkpoint is not implemented in SedovDataMPIFileWriter, exiting...\n");
